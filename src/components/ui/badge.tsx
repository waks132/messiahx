  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-green-500 text-white hover:bg-green-500/80 shadow",
        warning: "border-transparent bg-yellow-500 text-white hover:bg-yellow-500/80 shadow",
        info: "border-transparent bg-sky-500 text-white hover:bg-sky-500/80 shadow",
      },
    },
    defaultVariants: {
      variant: "default",
