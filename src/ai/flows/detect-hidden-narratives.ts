...
const DetectHiddenNarrativesOutputSchema = z.object({
  hiddenNarratives: z
    .string()
    .describe('The hidden narratives detected in the text, from a paranoid perspective.'),
});
...
const detectHiddenNarrativesPrompt = ai.definePrompt({
  ...
  Present your findings as a detailed report of the detected hidden narratives.
  `,
});
