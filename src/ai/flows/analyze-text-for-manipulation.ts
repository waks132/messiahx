...
- unverifiableFacts: Identify statements *presented as objective factual claims* within the text that are inherently difficult or impossible to verify empirically by a typical reader. Apply critical thinking and nuance; avoid listing common knowledge, easily deducible statements, or clearly subjective opinions not disguised as objective fact. These must have the appearance of factuality and be distinct from poetic expressions, literary devices, opinions, clearly subjective statements, hyperbolic rhetorical flourishes, or common knowledge. Focus *only* on claims that, if taken literally as factual, would require external proof that is not provided and is hard to obtain. When evaluating a statement, consider the apparent intent of the original author. Is the statement clearly hyperbolic, a metaphorical expression, an obvious opinion, or does it genuinely masquerade as an objective, verifiable claim while lacking such verifiability? Only list the latter. For each statement, provide the specific statement verbatim followed by a hyphen and a brief (1-sentence) justification of why it is considered unverifiable in this context. Your justification must explain why it is unverifiable in the given context, not just repeat the statement. Example format (ensure this example's labels are also in {{language}} in your output): "Statement - Justification". If the text is purely poetic or artistic and contains no such claims, this list should be empty.
